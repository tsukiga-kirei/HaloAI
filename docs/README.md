...
Every English document in this directory has a `.zh-CN.md` counterpart. A product, architecture, protocol, or security change is complete only when both versions remain semantically aligned.
