...
| Settings tabs   | System-settings tabs share the same horizontal selected state as section navigation and must not become a left rail. Mobile must not hang a dropdown under the section bar to switch settings groups                                                                                                                             |
