...
| Pagination        | System-admin card catalogs use 10/20/50 segmented pills. The pager keeps at least 16px inset from the container edge; page controls must not sit flush against the frame. Room message history keeps cursor pagination                                                                                                                                                                                                                                                                                                                                                   |
...
| Admin page header | Canvas headers are three levels: section kicker, page title, one-line description; primary actions sit on the right. Do not fake hierarchy with oversized titles or heavy card shadows                                                                                                                                                                                                                                                                                                                                                                                   |
| Admin cards       | Directories and settings use a thin border and no large drop shadow. Form controls are label plus input. Drawers must not wrap every field in its own card                                                                                                                                                                                                                                                                                                                                                                                                               |
