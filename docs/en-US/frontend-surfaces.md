...
- Administration canvas headers match the sidebar groups: a section kicker, the page title, a one-line description, and primary actions on the right. Create and edit flows use a right-side drawer with a header, scrolling form, and pinned footer; action buttons must not scroll out of view.
