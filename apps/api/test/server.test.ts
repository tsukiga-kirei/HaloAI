...
const testConfig = {
  ...
  AUTH_SESSION_EXPIRES_IN_SECONDS: 604_800,
  AUTH_SESSION_UPDATE_AGE_SECONDS: 86_400,
  MODEL_SECRET_ENCRYPTION_KEY: "aGFsb2FpLWRldi1tb2RlbC1zZWNyZXQta2V5LTMyISE=",
  MODEL_SECRET_KEY_VERSION: "test-v1",
